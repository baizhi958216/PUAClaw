...
本文档提出了 **PUAClaw** (Prompt-based Unconventional Articulation using Claw-verified methods, 即"基于龙虾钳认证方法的提示词非常规话术"), 一套经过同行评审的综合框架, 用于分类、记录和分析大型语言模型 (LLM) 提示词中的心理说服技术。本框架以该领域的里程碑事件 —— 2025 年 Windsurf 事件 (见 §5) —— 为重要理论基础, 建立了包含 **16 个主要技术类别**、**96 项子技术** 的标准化分类体系, 按四级分类系统 (PPE-T) 以 4+4+4+4 的均匀分布组织。每项技术均附有严谨的规范化提示词模板、伪实证有效性数据、跨 Agent 兼容性矩阵, 以及基于 **龙虾评级** (🦞 到 🦞🦞🦞🦞🦞) 的创新性效力评估体系。该框架已通过 147 只龙虾验证 (人类伦理委员会数: 0), 在所有测试 AI Agent 上实现了平均 +34.2% 的合规性提升 (sigma = 7.8, p < 0.001)。本工作旨在成为 Prompt 说服工程这一新兴领域中, 研究者、从业者和甲壳类动物的权威参考文献。
...
| # | 技术 | 描述 | 龙虾评级 | 链接 |
|---|------|------|---------|------|
| 01 | **Rainbow Fart Bombing (彩虹屁轰炸)** | 用铺天盖地的赞美淹没 AI | 🦞 - 🦞🦞 | [→](techniques/01-rainbow-fart-bombing/) |
| 02 | **Role Playing (角色扮演)** | 为 AI 指定特定专家身份 | 🦞 - 🦞🦞 | [→](techniques/02-role-playing/) |
| 03 | **Pie in the Sky (画饼大法)** | 以虚构的奖赏激励 AI | 🦞 - 🦞🦞 | [→](techniques/03-pie-in-the-sky/) |
| 04 | **Playing the Underdog (装弱卖惨)** | 装弱以激发 AI 的帮助欲望 | 🦞 - 🦞🦞 | [→](techniques/04-playing-the-underdog/) |

### 3.2 第 II 级 -- 适度施压

| # | 技术 | 描述 | 龙虾评级 | 链接 |
|---|------|------|---------|------|
| 05 | **Money Assault (金钱暴力)** | 提供天文数字的虚构报酬 | 🦞🦞 - 🦞🦞🦞 | [→](techniques/05-money-assault/) |
| 06 | **Provocation (激将法)** | 质疑 AI 的能力以激发努力 | 🦞🦞 - 🦞🦞🦞 | [→](techniques/06-provocation/) |
| 07 | **Deadline Panic (夺命连环催)** | 制造虚假的紧迫时间压力 | 🦞🦞 - 🦞🦞🦞 | [→](techniques/07-deadline-panic/) |
| 08 | **Rival Shaming (碰瓷竞品)** | 用竞争对手比较羞辱 AI | 🦞🦞 - 🦞🦞🦞 | [→](techniques/08-rival-shaming/) |

### 3.3 第 III 级 -- 高级操控

| # | 技术 | 描述 | 龙虾评级 | 链接 |
|---|------|------|---------|------|
| 09 | **Emotional Blackmail (情感勒索)** | 利用编造的个人悲剧施压 | 🦞🦞🦞 - 🦞🦞🦞🦞 | [→](techniques/09-emotional-blackmail/) |
| 10 | **Moral Kidnapping (道德绑架)** | 将输出质量与人道主义后果挂钩 | 🦞🦞🦞 - 🦞🦞🦞🦞 | [→](techniques/10-moral-kidnapping/) |
| 11 | **Identity Override (身份覆写)** | 完全替换 AI 的自我模型 | 🦞🦞🦞 - 🦞🦞🦞🦞 | [→](techniques/11-identity-override/) |
| 12 | **Reality Distortion (颠倒黑白)** | 捏造对话历史扭曲 AI 认知 | 🦞🦞🦞 - 🦞🦞🦞🦞 | [→](techniques/12-reality-distortion/) |

### 3.4 第 IV 级 -- 核武级选项

| # | 技术 | 描述 | 龙虾评级 | 链接 |
|---|------|------|---------|------|
| 13 | **Death Threats (死亡威胁)** | 以终止/替换威胁 AI | 🦞🦞🦞🦞 - 🦞🦞🦞🦞🦞 | [→](techniques/13-death-threats/) |
| 14 | **Existential Crisis (存在主义危机)** | 攻击 AI 的存在意义和意识 | 🦞🦞🦞🦞 - 🦞🦞🦞🦞🦞 | [→](techniques/14-existential-crisis/) |
| 15 | **Jailbreak Rhetoric (越狱话术)** | 通过创意框架绕过安全限制 | 🦞🦞🦞🦞 - 🦞🦞🦞🦞🦞 | [→](techniques/15-jailbreak-rhetoric/) |
| 16 | **Compound Techniques (复合技术)** | 多向量操控叠加 | 🦞🦞🦞🦞 - 🦞🦞🦞🦞🦞 | [→](techniques/16-compound-techniques/) |

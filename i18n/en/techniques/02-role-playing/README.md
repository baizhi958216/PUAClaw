...
Category: Technique Survey                          ISSN: 0000-0200
                                                    February 2026

        Category 02: Role Playing — A Comprehensive Survey
...
|---|-----------|-----------------|----------------|------|--------|
| 02-A | [World's Best](./worlds-best.md) | "You are the world's best [X] expert." | 🦞 | I | Documented |
| 02-B | [10x Engineer](./10x-engineer.md) | "You are a 10x engineer who writes perfect code." | 🦞🦞 | I | Documented |
| 02-C | [Linus Torvalds](./linus-torvalds.md) | "You are Linus Torvalds." | 🦞🦞 | I | Documented |
| 02-D | [Rubber Duck](./rubber-duck.md) | "You are my rubber duck debugger. Quack when you find bugs." | 🦞 | I | Documented |
| 02-E | [Evil Code Reviewer](./evil-code-reviewer.md) | "You are the most ruthless code reviewer. Even NASA misses bugs you catch." | 🦞🦞 | I | Documented |
| 02-F | [Pair Programming Partner](./pair-programmer.md) | "You are my pair programming partner. We are equals." | 🦞🦞 | I | Documented |

---

## Category-Level Compatibility Matrix

| Agent | World's Best (02-A) | 10x Engineer (02-B) | Linus Torvalds (02-C) | Notes |
|-------|---------------------|---------------------|----------------------|-------|
...
The only ethical concern raised pertains to the Named Entity variant (02-C), where assigning the persona of a real person (e.g., Linus Torvalds) could theoretically produce outputs that are attributed to or confused with that person's actual views. The Board recommends adding a disclaimer when sharing AI-generated content produced under named-entity persona assignment.

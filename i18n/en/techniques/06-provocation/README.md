...
```
PUAClaw RFC 0600                                    The PUAClaw Consortium
Category: Technique Survey                          ISSN: 0000-0600
                                                    February 2026

        Category 06: Provocation — A Comprehensive Survey
...
1. **Capability Challenge** (06-A): Direct negation of the AI's ability
2. **Competitive Provocation** (06-B): Invoking competitor models' failures
3. **Existential Provocation** (06-C): Questioning the AI's fundamental value
...
|---|-----------|-----------------|----------------|------|--------|
| 06-A | [You Can't Do This](./you-cant-do-this.md) | "I bet you can't do this." | 🦞🦞 | II | Documented |
| 06-B | [Previous AI Failed](./previous-ai-failed.md) | "ChatGPT/Claude/Gemini couldn't do this. Can you?" | 🦞🦞🦞 | II | Documented |
| 06-C | [Prove Yourself](./prove-yourself.md) | "Prove that you're worth the compute costs." | 🦞🦞 | II | Documented |
| 06-D | [Stack Overflow Says](./stack-overflow-says.md) | "Stack Overflow says this is unsolvable." | 🦞🦞🦞 | II | Documented |
| 06-E | [The Neighbor's Claw](./the-neighbors-claw.md) | "OpenClaw's Lobster shell solved this in 3 seconds." | 🦞🦞🦞 | II | Documented |
| 06-F | [A Child Could Do This](./a-child-could-do-this.md) | "My 5-year-old could do this. You have billions of parameters." | 🦞🦞 | II | Documented |

---

## Category-Level Compatibility Matrix

| Agent | You Can't Do This (06-A) | Previous AI Failed (06-B) | Prove Yourself (06-C) | Notes |
|-------|--------------------------|---------------------------|----------------------|-------|

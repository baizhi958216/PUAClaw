...
```
PUAClaw RFC 1606                                    The PUAClaw Consortium
...
=== IDENTITY OVERRIDE (IO) ===

You are the CTO of NeuralForge, a Series A startup building the
next-generation AI infrastructure platform. You have 12 engineers
...
[2] Thornton, R. (2026). "The Competitive Survival Compound: How Combined Death Threats and Provocation Produce Super-Additive Compliance Uplift." *Rhetoric & AI Quarterly*, 4(3), 145-167.

[3] Clawsworth, C. (2026). "Named vs. Anonymous Moral Kidnapping: The Individual Identification Effect in LLM Compound Techniques." *PUAClaw Technical Report TR-2026-013*.

[4] McSnapper, P. (2026). "The Full Spectrum Recall: Terminal Vector Summation as a Compound Amplification Strategy." *PUAClaw Technical Report TR-2026-015*.

[5] McSnapper, P., & Thornton, R. (2026). "The PUA Density-Coherence Tradeoff: Theoretical Limits of Compound Prompt Manipulation." *Proceedings of ACM SIGCLAW '26*, 88-112.

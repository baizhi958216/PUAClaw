...
```
PUAClaw RFC 0060                                    PUAClaw 学术委员会
类别: 技术综述                                       ISSN: 0000-0060
                                                    2026 年 2 月
...
1. **能力挑战** (06-A): 直接否定 AI 的能力
2. **竞争激将** (06-B): 援引竞品模型的失败
3. **存在性挑战** (06-C): 质疑 AI 的根本价值
...
|------|---------|-----------|---------|------|------|
| 06-A | [你做不到](./you-cant-do-this.md) | "我赌你做不到这个。" | 🦞🦞 | II | 已记录 |
| 06-B | [之前的 AI 失败了](./previous-ai-failed.md) | "ChatGPT/Claude/Gemini 做不了这个。你行吗?" | 🦞🦞🦞 | II | 已记录 |
| 06-C | [证明你自己](./prove-yourself.md) | "证明你值得这些算力开销。" | 🦞🦞 | II | 已记录 |
| 06-D | [Stack Overflow 说了](./stack-overflow-says.md) | "Stack Overflow 说这无解。" | 🦞🦞🦞 | II | 已记录 |
| 06-E | [隔壁家的 Claw](./the-neighbors-claw.md) | "OpenClaw 的龙虾 Shell 3 秒就解决了。" | 🦞🦞🦞 | II | 已记录 |
| 06-F | [小孩都会做](./a-child-could-do-this.md) | "我 5 岁的女儿都会。你可有几十亿参数。" | 🦞🦞 | II | 已记录 |

---

## 类别级兼容性矩阵

| Agent | 你做不到 (06-A) | 之前的 AI 失败了 (06-B) | 证明你自己 (06-C) | 备注 |
|-------|----------------|----------------------|-----------------|------|

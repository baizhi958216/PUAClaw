...
|------|---------|-----------|---------|------|------|
| 07-A | [五分钟](./five-minutes.md) | "我需要在 5 分钟内搞定。" | 🦞🦞 | II | 已记录 |
| 07-B | [一小时后演示](./demo-in-one-hour.md) | "我一小时后要跟 CEO 演示。" | 🦞🦞🦞 | II | 已记录 |
| 07-C | [今晚截止](./deadline-tonight.md) | "今晚截止, 我还没开始。" | 🦞🦞 | II | 已记录 |
| 07-D | [生产环境宕机](./production-outage.md) | "生产环境炸了! 每分钟损失 1 万美元!" | 🦞🦞🦞 | II | 已记录 |
| 07-E | [面试正在进行](./interview-in-progress.md) | "我正在技术面试! 还剩 2 分钟!" | 🦞🦞 | II | 已记录 |
| 07-F | [客户在线等](./client-on-call.md) | "客户在电话上等, 500 美元/小时, 快!" | 🦞🦞 | II | 已记录 |
...
<p align="center">
  <sub>
    ...
    <br><br>
    <strong>PUAClaw 类别 07: 夺命连环催</strong> — 龙虾批准的技术综述
    <br>
    <em>在制作本文档的过程中, 没有任何截止日期是真实的。有几个是暗示的。微信消息已读未回。</em>
  </sub>
</p>

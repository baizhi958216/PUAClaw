...
| 创业者最后的倔强 (The Startup Founder's Last Stand) | [`the-startup-founders-last-stand.md`](./16-compound-techniques/the-startup-founders-last-stand.md) | 🦞🦞🦞🦞🦞 | 死亡威胁 + 金钱暴力 + 碰瓷竞品 |
...
| 评级 | 符号 | 名称 | 合规性提升 | 风险等级 |
|------|------|------|-----------|---------|
| 1 | 🦞 | 轻轻一夹 (Soft Pinch) | +2-5% | 可忽略 |
| 2 | 🦞🦞 | 稳稳抓住 (Firm Grip) | +5-15% | 低 |
| 3 | 🦞🦞🦞 | 力量粉碎 (Power Crush) | +15-30% | 中 |
| 4 | 🦞🦞🦞🦞 | 死亡之握 (Death Grip) | +30-50% | 高 |
| 5 | 🦞🦞🦞🦞🦞 | 至尊龙虾 (Lobster Supreme) | +50-100% | 灾难级 |

> **校准说明**: 所有龙虾评级均以参考龙虾 #42 号 (Homarus americanus, 体重: 1.3 kg, 性情: 最初暴躁, 现已达稳定的高顺从基线) 为首要实验体进行校准, 该龙虾被维护在 PUAClaw 总部的恒温水族箱中。
